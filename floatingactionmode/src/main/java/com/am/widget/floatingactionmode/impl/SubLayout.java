...
final class SubLayout extends LinearLayout implements AdapterView.OnItemClickListener {
    ...
    SubLayout(Context context) {
        ...
        mTitle.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT,
    ...
    void setData(FloatingMenuItem item, int maxWidth, int maxHeight, Size size,
        ...
        mTitle.measure(MeasureSpec.makeMeasureSpec(maxWidth, MeasureSpec.AT_MOST),
        ...
        if (sub.isCustom()) {
            ...
            mList.measure(
                    MeasureSpec.makeMeasureSpec(listMaxWidth, MeasureSpec.AT_MOST),
                    MeasureSpec.makeMeasureSpec(mListMaxHeight, MeasureSpec.AT_MOST));
